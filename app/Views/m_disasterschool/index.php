          ...
          <div class="card-header">
            <div class = "row">
              ...
              <div class="col-6 text-right">
                <a href="<?= baseUrl('mdisasterschool/add')?>"><i class = "fa fa-plus"></i> <?= lang('Form.add')?></a>
              </div>
            </div>
          </div>
          <div class="card-body">
...
<!-- modal -->
<div id="modalVillageDisaster" tabindex="-1" role="dialog" aria-labelledby="disasterschoolModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="disasterschoolModalLabel" class="modal-title"><?= lang('Form.picture')?></h5>
...
<script>
  ...
  function dataTable(){
    var table = $('#tableVillageDisaster').DataTable({
      ...
      "serverSide": true,
      ajax:{
        url : "<?= baseUrl('M_disasterschool/getAllData')?>",
        dataSrc : 'data'
      },
      stateSave: true
    }); 
     ...
     table.on( 'click', '.delete', function (e) {
        ...
        deleteData(name, function(result){
          if (result==true)
          {
            ...
            $.ajax({
              type : "POST",
              url : "<?= baseUrl('mdisasterschool/delete/');?>",
              data : {id : data[0]},
    ...
    table.on( 'click', '.image', function (e) {
      ...
      $.ajax({
        type : "POST",
        url : "<?= baseUrl('mdisasterschool/getData');?>",
        data : {id : data[0]},
        success : function(data){
          ...
          var label = document.getElementById("disasterschoolModalLabel");
