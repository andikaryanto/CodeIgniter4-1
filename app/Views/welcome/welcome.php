<section>
    ...
    <section>
    <!-- <a class="twitter-timeline" href="https://twitter.com/BPBD_Sleman?ref_src=twsrc%5Etfw">Tweets by BPBD_Sleman</a> 
        ...
        <script>
            ...
            var loc = {
                ...
                "properties": {
                    ...
                    "status": "<?php echo App\Eloquents\M_enumdetails::getEnumName("DisasterOccurStatus", $data->Status) ?>",
            ...
            geojson.features.forEach(function(e) {
                ...
                console.log(e.properties.markerUrl );
