...
<section>
  <div class="container-fluid">
    <!-- Page Header-->
    <header>
      <h1 class="h3 display"><?= lang('Form.disasterimpact') . " ({$disasteroccur->TransNo} ~ {$disasteroccur->get_M_Disaster()->Name})" ?> </h1>
      </tr>
    </header>
    <div class="row">
      <div class="col-lg-12">
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-6 text-right">
                <!-- <a href="<?= baseUrl('tdisasteroccurimpact') ?>"><i class = "fa fa-table"></i> Data</a> -->
              </div>
            </div>
          </div>
          <div class="card-body">
            <?= formOpen(baseUrl('tdisasteroccurimpact/addsave')) ?>
            <?= formInput(
              array(
            ...
            <div class="form-group">
              ...
              <?= formLink(
                lang('Form.cancel'),
                array(
                  "href" => baseUrl("tdisasteroccurimpact/{$disasteroccur->Id}"),
