  ...
  <div class="container-fluid">
    ...
    <header>
      <h1 class="h3 display">
        ...
        <?= lang('Form.disastervictim') . " ({$disasteroccur->TransNo} ~ {$disasteroccur->get_M_Disaster()->Name})" ?> </h1>
      </tr>
    </header>
    <div class="row">
      <div class="col-lg-12">
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-6 text-right">
                <a href="<?= baseUrl("tdisasteroccurbuilding/add/{$disasteroccur->Id}") ?>"><i class="fa fa-plus"></i> Dampak Bangunan</a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <?= formOpen(baseUrl('tdisasteroccurvictim/addsave')) ?>
            <?= formInput(
              array(
              ...
              <div class="col-12">
                <div class="form-group">
                  <div class="i-checks">
                    ...
                    <?= formLabel(lang('Form.usefamilycard'), array("for" => "usefamilycard")) ?>
...
<script>
  ...
  //   changeFamilyCardId('0');
  // });

  $("#btnFamilymember").on("click", (function(e) {
    var familycard = $("#M_Familycard_Id").val();
    if (familycard) {
      changeMemberFamilyCardId(familycard);
    } else {
      changeMemberFamilyCardId(0);
    }
  }))
