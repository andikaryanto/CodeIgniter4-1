          ...
          <div class="card-header">
            <div class = "row">
              ...
              <div class="col-6 text-right">
                <a class = "link-action" href="<?= baseUrl('moccupation')?>"><i class = "fa fa-table"></i> <?= lang('Form.occupation')?></a>
                <a href="<?= baseUrl('memployee/add')?>"><i class = "fa fa-plus"></i> <?= lang('Form.add')?></a>
              </div>
            </div>
          </div>
          <div class="card-body">
...
<script>
  ...
  function dataTable(){
    var table = $('#tableGroupUser').DataTable({
      ...
      "serverSide": true,
      ajax:{
        url : "<?= baseUrl('memployee/getAllData')?>",
        dataSrc : 'data'
      },
      stateSave: true
    }); 
