          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-6 text-right">
                <a href="<?= baseUrl('mvolunteer/add') ?>"><i class="fa fa-plus"></i> <?= lang('Form.add') ?></a>
              </div>
            </div>
          </div>
          <div class="card-body">
...
<script>
  ...
  function dataTable() {
    var table = $('#tableGroupUser').DataTable({
      ...
      "serverSide": true,
      ajax: {
        url: "<?= baseUrl('mvolunteer/getAllData') ?>",
        dataSrc: 'data'
      },
      stateSave: true
    });
