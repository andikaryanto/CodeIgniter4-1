<!-- modal -->
<div id="modalItem" tabindex="-1" role="dialog" aria-labelledby="itemModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="itemModalLabel" class="modal-title"><?= lang('Form.item')?></h5>
