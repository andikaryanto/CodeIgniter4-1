          ...
          <div class="card-header">
            <div class = "row">
              ...
              <div class="col-6 text-right">
                <a href="<?= baseUrl('mvillagedisaster/add')?>"><i class = "fa fa-plus"></i> <?= lang('Form.add')?></a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table id = "tableVillageDisaster" style="width: 100%;" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed " role="grid">
  ...
  <div role="document" class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="villagedisasterModalLabel" class="modal-title"><?= lang('Form.picture')?></h5>
...
<script>
  ...
  function dataTable(){
    var table = $('#tableVillageDisaster').DataTable({
      ...
      "serverSide": true,
      ajax:{
        url : "<?= baseUrl('mvillagedisaster/getAllData')?>",
        dataSrc : 'data'
      },
      stateSave: true
    }); 
     ...
     table.on( 'click', '.delete', function (e) {
        ...
        deleteData(name, function(result){
          if (result==true)
          {
            ...
            $.ajax({
              type : "POST",
              url : "<?= baseUrl('mvillagedisaster/delete/');?>",
              data : {id : data[0]},
    ...
    table.on( 'click', '.image', function (e) {
      ...
      $.ajax({
        type : "POST",
        url : "<?= baseUrl('mvillagedisaster/getData');?>",
        data : {id : data[0]},
        success : function(data){
          ...
          var label = document.getElementById("villagedisasterModalLabel");
