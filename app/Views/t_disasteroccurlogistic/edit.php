...
<section>
  <div class="container-fluid">
    <!-- Page Header-->
    <header>
      <h1 class="h3 display"><?= lang('Form.disasterlogistic') . " ({$disasteroccur->TransNo} ~ {$disasteroccur->get_M_Disaster()->Name})" ?> </h1>
      </tr>
    </header>
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <?= formOpen(baseUrl('tdisasteroccurlogistic/editsave')) ?>
            <?= formInput(
              array(
