...
<section>
  <div class="container-fluid">
    <!-- Page Header-->
    <header> 
          <h1 class="h3 display"><?= lang('Form.capability')?> </h1>
      </tr>
    </header>
    <div class="row">
      <div class="col-lg-12">
          ...
          <div class="card-header">
            <div class = "row">
              ...
              <div class="col-6 text-right">
                <!-- <a href="<?= baseUrl('mcapability')?>"><i class = "fa fa-table"></i> Data</a> -->
              </div>
            </div>
          </div>
          <div class="card-body">                
            <?= formOpen(baseUrl('mcapability/editsave'))?>
                <?= formInput(
                    array("id" => "Id",
                          "name" => "Id",
                          "value" => $model->Id,
              ...
              <div class="form-group">
                <div class = "required">
                  <?= formLabel(lang('Form.capability'))?>
                  <?= formInput(
                        array("id" => "Name",
                              "type" => "text",
