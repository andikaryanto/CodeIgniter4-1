          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-6 text-right">
                <!-- <a href="<?= baseUrl('minfrastructurecategory') ?>"><i class = "fa fa-table"></i> Data</a> -->
              </div>
            </div>
          </div>
          <div class="card-body">
            <?= formOpenMultipart(baseUrl('minfrastructurecategory/editsave')) ?>
            <?= formInput(
              array(
                "id" => "Id",
                "name" => "Id",
            ...
            <div class="form-group">
              ...
              <?= formLink(lang('Form.cancel'), array(
                "href" => baseUrl('minfrastructurecategory'),
