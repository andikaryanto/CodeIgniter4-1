<!-- modal -->
<div id="modalWarehouse" tabindex="-1" role="dialog" aria-labelledby="warehouseModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="warehouseModalLabel" class="modal-title"><?= lang('Form.warehouse')?></h5>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="table-responsive">
                  <table data-page-length="5" id = "tableModalWarehouse" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
...
<script>
    ...
    function loadModalWarehouse(){
      ...
      tableWarehouse = $("#tableModalWarehouse").DataTable({
        ...
        "serverSide": true,
        ajax:{
            url : "<?= baseUrl('mwarehouse/getDataModal')?>",
            dataSrc : 'data'
        },
        stateSave: true
      });
      ...
      tableWarehouse.on( 'click', '.rowdetail', function () {
            ...
            $("#warehouse").val(data[1]);
            $('#modalWarehouse').modal('hide');
      } );
    }

    $('#modalWarehouse').on('show.bs.modal', function (e) {
