    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <?= formOpen(baseUrl('mwarehouse/editsave')) ?>
            <?= formInput(
              array(
                "id" => "M_Village_Id",
                "name" => "M_Village_Id",
            ...
            <div class="form-group">
              ...
              <div class="input-group has-success">
                ...
                <div class="input-group-append">
                  <button onclick="clear()" id="btnGroupModal" data-toggle="modal" type="button" class="btn btn-primary" data-target="#modalVillage"><i class="fa fa-search"></i></button>
                </div>
              </div>
            </div>
            <div class="form-group">
